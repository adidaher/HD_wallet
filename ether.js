...
var web3 = new Web3("https://ropsten.infura.io/v3/4f7cd3c497084d19a83469953b4d55a1");
		...
		password: password,
	  	...
	  	ks.keyFromPassword(password, function (err, pwDerivedKey) {
	    	...
	    	else
	    	{
	    		...
	    		var web3 = new Web3(new Web3.providers.HttpProvider('https://ropsten.infura.io/v3/4f7cd3c497084d19a83469953b4d55a1'));
	    		var html = "";
...
function check_balance(){
	...
	const web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infura.io/v3/4f7cd3c497084d19a83469953b4d55a1"))
	...
	web3.eth.getBalance(AddressTobalance, function(err, result) {
	  if (err) {
		...
		document.getElementById("details").value ="Account Balance "+ web3.utils.fromWei(result, "ether") + " ETH";
	  }
	})
